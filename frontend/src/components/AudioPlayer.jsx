            ...
            <div className="result-header">
                ...
                <div className="action-group">
                    <button className="action-btn" onClick={handleShare} style={{ gap: '6px' }}>
                        <svg width="22" height="22" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
                            <path d="M363.3 227l-.1-.1c0-43.9-46.7-79.6-104.4-79.6-57.8 0-104.4 35.7-104.4 79.6 0 43.9 46.7 79.6 104.4 79.6s104.4-35.7 104.4-79.6zM219.7 213c-6.5 0-11.8-5.3-11.8-11.8s5.3-11.8 11.8-11.8 11.8 5.3 11.8 11.8-5.3 11.8-11.8 11.8zm78.6 0c-6.5 0-11.8-5.3-11.8-11.8s5.3-11.8 11.8-11.8 11.8 5.3 11.8 11.8-5.3 11.8-11.8 11.8zM448 358c0-54.3-64-98.3-143-98.3-9.5 0-18.4.7-27.1 2 24 18.2 38.6 42.1 38.6 67.9 0 48-49.8 87.2-111.4 87.2-10 0-19.6-.9-28.7-2.4l-63.5 35.6 24-33c-36.9-20.9-61.9-54.4-61.9-92 0-3.5.3-6.9.7-10.3C30.6 319.4 0 348.6 0 382.4c0 36.1 39.5 65.5 88.3 65.5 8.9 0 17.4-.9 25.5-2.6l64.2 34.6-12.8-44.4c64.1 6.5 120.3-25.7 121.3-43.2.1-.2.3-.5.4-.7 9.8 1.4 20.1 2.2 30.7 2.2 79.1 0 143.9-35.1 143.9-75.9z" fill="#07C160" />
                        </svg>
                        分享音频
                    </button>
